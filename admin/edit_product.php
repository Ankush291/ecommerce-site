            ...
            <form id="updateProduct" class="add-post-form row" method="post" enctype="multipart/form-data">
                <div class="col-md-9">
                    ...
                    <div class="form-group category">
                        ...
                        $result2 = mysqli_query($conn, $cat_sql);
                    ...
                    <div class="form-group sub_category">
                        ...
                        <?php
                        $sub_cat_sql = "SELECT * FROM sub_categories WHERE cat_parent = {$row['product_cat']}";
                        $result3 = mysqli_query($conn, $sub_cat_sql);
                    ...
                    <div class="form-group brand">
                        ...
                        $result4 = mysqli_query($conn, $brand_sql);
